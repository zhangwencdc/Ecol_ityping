...
if($keyn>0){
	foreach my $k (@key) {
		print OUT "$k detected\n";print "$k detected\n";
	}
}else{
	print OUT "No EPEC/EHEC/EIEC/ETEC/EAEC marker detected";
	print "No EPEC/EHEC/EIEC/ETEC/EAEC marker detected";
}

#生成报告
system "python $Bin/Mark_covert_html-v2.py $key.report\n";
#====================================================================================================================
#  +------------------+
#  |   subprogram     |
#  +------------------+
